...
gelman.full.PAA<-ggplot(melt(gp.dat.frame, c("q","last.iter"), value.name="shrink_factor"), 
       aes(last.iter, shrink_factor, colour=q, linetype=q)) + 
  geom_hline(yintercept=1, colour="grey30", lwd=0.2) +
  geom_line() +
  facet_grid(rows = vars(variable)) +
...
gelman.neg.PAA<-ggplot(melt(gp.dat.frame.neg, c("q","last.iter"), value.name="shrink_factor"),
       aes(last.iter, shrink_factor, colour=q, linetype=q)) +
  geom_hline(yintercept=1, colour="grey30", lwd=0.2) +
  geom_line() +
  facet_grid(rows = vars(variable)) +
