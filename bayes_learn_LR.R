...
scenarios_select<-list(BT_log_sca=
                         c("scaleConst", "interpReg","slopRegRelAC",
                           "slopRegPVL"),
                       BT_gam_log_sca=
                         c("scaleConst","gamma0","interpReg","slopRegRelAC",
                           "slopRegPVL"),
                       BT_Nrew_log_sca=
                         c("scaleConst","negReward0","interpReg","slopRegRelAC",
                           "slopRegPVL"))
# ,
