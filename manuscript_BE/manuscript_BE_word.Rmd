---
title: | 
  Title: Field and experimental data together with computational models reveal how cleaner fish adjust decisions  in a biological market
# author:
...
subtitle: |
  Abbreviated title: Cleaner fish cognitive mechanisms in a biological market
...
## Lay summary
  ...
  Cleaner fish, reef fish that feed of ectoparasites of other fishes, often choose among alternative clients. For the cleaner fish is better to choose certain clients, a choice that favours obtaining food in the future. Thus, cleaners must "look" into the future to make the right choice. By combining a learning model with data, we show that cleaners estimate the long-term value of their actions rather than using simpler heuristics. Estimating long-term value is a mechanism involved in human foresight.  
...
clever experiments to show the behavior displayed requires inferences made 
...
by performing cognitive tests in the context of
...
behaviors to the varying conditions. More specifically the question arises 
...
[@reader_Evolution_2011], shows that performance in the task
...
reward task has used a broad approach as proposed by
...
Over the last decade, over a hundred wild-caught cleaner fish have been tested
...
reward - the prediction error- [@sutton_Reinforcement_2018; 
...
From the study by @triki_Biological_2019 
...
based solely on the behavior-cue of the plates rather than size-cue 
...
visitor/resident Plexiglas plates were swapped 
