...
conditions, it is possible to assess the explanatory power 
of the different hypotheses by performing behavioural test in the context of
...
```{r pred, fig.cap='(ref:pred)',out.width='100%',fig.height=5,cache=FALSE}
